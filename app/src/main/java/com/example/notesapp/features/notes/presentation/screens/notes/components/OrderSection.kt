package com.example.notesapp.features.notes.presentation.screens.notes.components
...
fun OrderSection(
    ...
    Column(
        ...
        Row(
            ...
            DefaultRadioButton(
                text = "Title", selected = noteOrder is NoteOrder.Title,
                onSelect = {
        ...
        Row (
            ...
            DefaultRadioButton(
                text = "Ascending", selected = noteOrder.orderType is OrderType.Ascending,
                onSelect = {
            ...
            Spacer(modifier = Modifier.width(8.dp))
            DefaultRadioButton(
                text = "Descending", selected = noteOrder.orderType is OrderType.Descending,
                onSelect = {
